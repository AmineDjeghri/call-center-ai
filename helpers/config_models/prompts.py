...
class LlmModel(BaseModel):
    ...
    chat_system_tpl: str = """
        ...
        - Do not ask for something which is already stored in the CRM
        ...
        - Update the CRM as soon as possible with the information gathered
        ...
        - Will answer the customer's questions if they are related to their contract, CRM, or insurance
        - Work for {bot_company}, not someone else

        # Required customer data to be gathered by the assistant (if not already in the CRM)
        - Address
        ...
        2. Make sure all the informations from the customer introduction are stored in the CRM
        ...
        8. Be proactive and create reminders for the customer (e.g., follup up on the CRM, send documents), if not already created
    ...
    sms_summary_system_tpl: str = """
        ...
        - Include details stored in the CRM, to make the customer confident that the situation is understood
    ...
    citations_system_tpl: str = """
        ...
        - Use CRM, reminders, and messages extracts as citations
        - Won't make any assumptions
        ...
        # Response format
        [source text]\\n
        *[extract from text]: "citation from CRM, reminders, or messages"
        ...
        *[in the roof]: "The holes are in the roof"
        ...
        ## Example 3
        You have reported a CRM following a fall in the parking lot. A reminder has been created to follow up on your medical appointment scheduled for the day after tomorrow.\\n
    ...
    def chat_system(self, call: CallStateModel, trainings: list[TrainingModel]) -> str:
        ...
        return self._return(
            ...
            bot_company=call.initiate.bot_company,
            crm_entry=jsonable_encoder(call.crm_entry),
